...
using System.Xml;
using LogisTechBase.CustomMarkers;
using GMap.NET;
   ...
   public partial class MapMainForm : Form
   {
      ...
      public MapMainForm()
      {
         ...
         if(!DesignMode)
         {
            ...
            // config map 
            MainMap.Position = new PointLatLng(39.6961334816182, 116.2985095977783);
      ...
      void MainMap_OnTileLoadComplete(long ElapsedMilliseconds)
      {
         ...
         MethodInvoker m = delegate()
         {
            panelMenu.Text = "上次装载地图使用了 " + MainMap.ElapsedMilliseconds + "ms";
