...
//             where r.checkDate between @startDate and @endDate )";
        ...
        public static bool PersonExist(Person p)
        {
            ...
            //{
            //    int result = 0;
            //    result = int.Parse(SQLiteHelper.ExecuteScalar(dbPath, SqlCheckSpecialPersonExist, new object[1] { p.id_num }).ToString());
            //    if (result >= 1)
            //    {
            //        bR = true;
            //    }
        ...
        public static List<Person> GetPersonList()
        {
            ...
            //    return null;
            //}
            DataTable tbPerson = nsConfigDB.ConfigDB.getTable(Program.personTableName);
            ...
            */
            if (tbPerson != null)
            {
                ...
                {
                    Person p = new Person(
                                          tbPerson.Rows[i]["key"].ToString(),
                                          tbPerson.Rows[i]["xm"].ToString(),
                                          tbPerson.Rows[i]["tel"].ToString(),
                                          tbPerson.Rows[i]["email"].ToString(),
                                          tbPerson.Rows[i]["bj"].ToString(),
                                          tbPerson.Rows[i]["nj"].ToString(),
                                          tbPerson.Rows[i]["uniqueID"].ToString()
                                          );
                    personList.Add(p);
                }
            }
